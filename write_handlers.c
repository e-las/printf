	...
	int flags, int width, int precision, int size)
{
	...
	if (is_negative)
		...
		extra_ch = ' ';
	return (write_numba(ind, buffer, flags, width, precision,
		length, padd, extra_ch));
}

/**
 * write_numba - Write a number using a bufffer
 ...
 */
int write_numba(int ind, char buffer[],
